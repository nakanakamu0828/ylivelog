<template>
  <app-layout>
    ...
    <div class="flex flex-row justify-center">
      ...
      <div
        v-if="isLoggined"
        class="w-full sm:max-w-sm bg-white shadow-md rounded mt-5 mx-1 px-2 sm:px-4 pt-6 pb-8 mb-4"
      >
        <form
          class="mb-4"
      ...
      <div
        v-else
        class="w-full max-w-sm text-center mt-5 pt-6 pb-8"
      >
        <google-login-button
...
export default {
  components: { AppLayout, GoogleLoginButton, Alert, VideoCard, ChatCard },
  head: {
    title: {
